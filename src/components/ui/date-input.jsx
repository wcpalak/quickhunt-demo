    ...
    return (
        <div className="flex border rounded-lg items-center text-sm px-1">
            <Input
                ...
                className="p-0 outline-none w-7 border-none text-center text-sm border-none p-0 h-auto focus-visible:ring-offset-0 focus-visible:ring-0"
                placeholder="D"
            />
            ...
            <Input
                ...
                className="p-0 outline-none w-6 border-none text-center text-sm border-none p-0 h-auto focus-visible:ring-offset-0 focus-visible:ring-0"
                placeholder="M"
            />
            <span className="opacity-20 -mx-px">/</span>
            ...
            <Input
                ...
                className="p-0 outline-none w-12 border-none text-center text-sm border-none p-0 h-auto focus-visible:ring-offset-0 focus-visible:ring-0"
                placeholder="YYYY"
            />
        </div>
    )
